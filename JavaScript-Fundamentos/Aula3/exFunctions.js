...
carro.passageiros = function(x) {
  var vagas = carro.assentos - carro.quantidadePessoas;
  var plural = vagas === 1 ? " pessoa" : " pessoas";
...
/* Agora vamos verificar algumas informações do carro. Para as respostas abaixo, utilize sempre o formato de invocação do método (ou chamada da propriedade), adicionando comentários inline ao lado com o valor retornado, se o método retornar algum valor.
...
carro.obterMarcaModelo() //'Esse carro é um FIAT IDEA'
